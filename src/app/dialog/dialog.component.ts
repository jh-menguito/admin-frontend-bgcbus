...
export class DialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.personalForm = this.formBuilder.group({
      ...
      Number: ['', [Validators.required, Validators.pattern('[0-9]{10}')]], //must be 11 digit numbers
   })
  ...
  if (this.editData) {
    ...
    this.personalForm.controls['Gender'].setValue(this.editData.Gender);
    this.personalForm.controls['Birthday'].setValue(this.editData.Birthday);
    this.personalForm.controls['Email'].setValue(this.editData.Email);
    this.personalForm.controls['Number'].setValue(this.editData.Number);
  }
}
